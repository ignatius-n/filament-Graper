...
{
    public static function getId(): string { return 'test-stub'; }
    public static function getName(): string { return 'Test Stub'; }
...
class FirstBlockStub extends Block
{
    ...
    public static function getCategory(): string { return 'Test'; }
    public function getTemplate(): string { return '<div>1</div>'; }
...
class SecondBlockStub extends Block
{
    ...
    public static function getCategory(): string { return 'Test'; }
    public function getTemplate(): string { return '<div>2</div>'; }
    public static function getOrder(): int { return 10; }
}

class MarketingBlockStub extends Block
{
    public static function getId(): string { return 'marketing'; }
    public static function getName(): string { return 'Marketing'; }
...
{
    public static function getId(): string { return 'content'; }
    public static function getName(): string { return 'Content'; }
...
{
    public static function getId(): string { return 'block-a1'; }
    public static function getName(): string { return 'Block A1'; }
    public static function getCategory(): string { return 'A'; }
    public function getTemplate(): string { return '<div>1</div>'; }
}

class CategoryBBlockStub extends Block
{
    public static function getId(): string { return 'block-b'; }
    public static function getName(): string { return 'Block B'; }
    public static function getCategory(): string { return 'B'; }
    public function getTemplate(): string { return '<div>2</div>'; }
}

class CategoryA2BlockStub extends Block
{
    public static function getId(): string { return 'block-a2'; }
    public static function getName(): string { return 'Block A2'; }
    public static function getCategory(): string { return 'A'; }
    public function getTemplate(): string { return '<div>3</div>'; }
}
