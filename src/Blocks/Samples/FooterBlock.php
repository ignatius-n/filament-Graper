  ...
  <div class="container mx-auto px-4 max-w-6xl">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
      <div class="col-span-2 md:col-span-1">
        <div class="text-white font-bold text-lg mb-3">YourBrand</div>
        <p class="text-sm leading-relaxed mb-4">Building better products for a better world. Join thousands of teams already using our platform.</p>
    ...
    <div class="border-t border-slate-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
      ...
      <p class="text-sm">Made with <span class="text-rose-400">&#9829;</span> by our team</p>
    </div>
  </div>
</footer>
HTML;
    ...
    {
        return <<<'HTML'
<footer class="bg-gray-800 dark:bg-gray-900 py-16">
  <div class="mx-auto w-full max-w-screen-xl px-4">
    <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
      <div class="col-span-2 md:col-span-1">
        <a href="#" class="flex items-center mb-4">
          <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">YourBrand</span>
        </a>
        <p class="text-gray-400 text-sm">Building better products for a better world.</p>
      </div>
      <div>
    ...
    <div class="px-4 py-6 bg-gray-700 md:flex md:items-center md:justify-between rounded-lg">
      <span class="text-sm text-gray-300 sm:text-center">&copy; 2025 YourBrand. All Rights Reserved.</span>
    </div>
  </div>
</footer>
HTML;
...
<footer class="bg-background border-t border-border py-16">
  <div class="container mx-auto px-4 max-w-6xl">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
      <div class="col-span-2 md:col-span-1">
        <div class="font-bold text-foreground text-lg mb-3">YourBrand</div>
        <p class="text-sm text-muted-foreground leading-relaxed mb-4">Building better products for a better world.</p>
      ...
      <div>
        <h3 class="font-semibold text-foreground text-sm mb-4">Product</h3>
        <ul class="space-y-2 text-sm text-muted-foreground">
          ...
          <li><a href="#" class="hover:text-foreground transition-colors">Roadmap</a></li>
        </ul>
      </div>
      <div>
        <h3 class="font-semibold text-foreground text-sm mb-4">Company</h3>
        <ul class="space-y-2 text-sm text-muted-foreground">
      ...
      <div>
        <h3 class="font-semibold text-foreground text-sm mb-4">Legal</h3>
        <ul class="space-y-2 text-sm text-muted-foreground">
    ...
    <div class="border-t border-border pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
      <p class="text-sm text-muted-foreground">&copy; 2025 YourBrand. All rights reserved.</p>
      <p class="text-sm text-muted-foreground">Made with care by our team</p>
    </div>
  </div>
</footer>
HTML;
